...
<head>
    ...
    <style>
        ...
        @media (max-width: 575.98px) { /* Extra small devices */
            .bar-chart-container {
                height: 400px; /* Allow more height for readability if subjects are many */
            }
        }
    </style>
</head>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tfoot class="table-group-divider">
                                        ...
                                        @php
                                            ...
                                            $overall_combined_percentage = 0;
                                            if ($total_lecture_slots_available > 0) {
                                                $overall_combined_percentage = ($total_attended_events / $total_lecture_slots_available) * 100;
                                            } elseif ($total_attended_events > 0) {
                                                $overall_combined_percentage = 100;
                                            }
                                        @endphp
                                        <tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (combinedBarCtx && processedAttendDataJS && processedAttendDataJS.length > 0) {
                // Use subject_short_name for labels, fallback to subject_name if short_name is not available
                ...
                new Chart(combinedBarCtx, {
                    type: 'bar',
                    data: {
                        labels: subjectLabels, // Using short names here
                        datasets: [
                            {
